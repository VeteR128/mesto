...
const closeOpenBtn = document.querySelector(".popup_type_open-close");
const closeEdit = document.querySelector(".popup_type_edit-close");
const closeAddBtn = document.querySelector(".popup_type_add-close");
